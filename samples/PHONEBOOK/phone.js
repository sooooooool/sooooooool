    ...
    AddressBook.prototype.fetchData = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, fetchContacts().then(function (response) {
...
function test2() {
    return __awaiter(this, void 0, void 0, function () {
        var addressBook, byName;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    addressBook = new AddressBook();
                    return [4 /*yield*/, addressBook.fetchData()];
                case 1:
                    _a.sent();
                    byName = addressBook.findContactByName("마동석");
                    console.log(byName);
                    return [2 /*return*/];
            }
        });
